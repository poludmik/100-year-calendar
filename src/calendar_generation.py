...
for year in range(2000, 2100):
    ...
    d.rectangle([(0 + 10 + rightshift, 26 + downshift), (560 + rightshift, 429 + downshift)], outline=(0, 0, 0), width=3)
...
new_layer.text((1240, 890), ascii.AsciiArts.skull, font=font, fill=(0, 0, 0, 100))
